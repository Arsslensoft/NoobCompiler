...
public CompilationUnit Unit;
	...
	void stmt(ref Statement sstmt) {
		if (la.kind == 1) {
			...
			Get();
			sstmt  = new IfStatement  { Location = new Location(t.line, t.col, t.charPos) } ; Expression e = null; Statement fst=null,tst=null; 
			expr(ref e);
			Expect(9);
			stmt(ref tst);
			Expect(10);
			...
			Get();
			sstmt  = new WhileStatement  { Location = new Location(t.line, t.col, t.charPos) } ; Expression e = null; Statement st=null; 
			expr(ref e);
			Expect(12);
			stmt(ref st);
